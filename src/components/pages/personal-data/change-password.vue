      ...
      <div action id="register-form">
        ...
        <!--<footer class="form-footer" id="footer-fixed">
            <div class="footer-wrap">
                <button type="button" class="form-button" @click="next()">
                ...
                <div class="activation-form">
                    ...
                    <div class="scroll-wrapper">
                        <div class="activation-code pattern-key-block-title">
                            <h2 class="section-main-title activation-title">Для смены пароля укажите новый пароль и нажмите "Сменить пароль"</h2>
                        </div>
                    ...
                    <footer-form>
                        <ui-button class="form-button" @on-click-do="next()"><template slot="icon"><img src="/assets/img/change-password/password.svg" alt="пароль"></template> Сменить пароль</ui-button>
  ...
  mounted() {
    ...
    var lock = new PatternLock("#patternContainer",{
        onDraw:function(pattern:any){            
            self.$app.PasswordChange.password = self.password = pattern;
            let pas = pattern
            console.log(pas);     
        }
    });
